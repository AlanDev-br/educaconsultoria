...
const SOCIAL_LINKS = [
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/educaconsultoria_/",
    icon: (
      <svg
        width="18"
        height="18"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-xs mb-4">
              Soluções completas em educação, consultoria, design, tradução e
              produção musical. Maceió – AL, atendendo todo o Brasil.
            </p>
        ...
        <div className="border-t border-white/10 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/40 text-xs">
            © {year} Educa Consultoria e Serviços Ltda. Todos os direitos
            reservados.
          </p>
